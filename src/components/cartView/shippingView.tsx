                  ...
                  <TableBody>
                     ...
                     <TableRow>
                        <TableCell>
                           ...
                           <div className={classes.leftMargin}>
                              Order lagt innan kl. 22.00 skickas med bud
                              söndag-torsdag kväll. Preliminär leverans imorgon.
                           </div>
                        </TableCell>
                        <TableCell className={classes.paddingLeft}>
                           <FormControl
                     ...
                     <TableRow>
                        <TableCell>
                           ...
                           <span>Earlybird</span>
                           <div className={classes.leftMargin}>
                              Levereras innan 07:00 till din brevlåda, större
                              försändelser lämnas vid dörren eller brevlådan
                           </div>
                        </TableCell>
                        <TableCell className={classes.paddingLeft}>
                           <FormControl
                     ...
                     <TableRow>
                        ...
                        <TableCell className={classes.paddingLeft}></TableCell>
                        <TableCell className={classes.paddingLeft}>
                           0 kr
                        </TableCell>
                     </TableRow>
